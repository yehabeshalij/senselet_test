...
// // // // //  * "ቅናሽ" የሚባል የተለየ field አያስፈልግም - ቀሪው ራሱ በራሱ ከተጫነው ልክ ይሰላል።
// // // // //  */
...
// // // // //     where: { truckId, isActive: true, ...(filters?.source ? { source: filters.source } : {}), ...(filters?.method ? { method: filters.method } : {}) },
...
// // // // // // የቆየው ደረሰኝ (createdAt) ከላይ፣ አዲሱ ከስር - ልክ ፍሮንት ኤንዱ ላይ እንደተስማማነው
// // // // // router.get('/warehouse-items', async (req: Request, res: Response) => {
// // // // //   try {
// // // // //     const page = Math.max(1, Number(req.query.page) || 1);
// // // // //     const pageSize = Math.max(1, Number(req.query.pageSize) || 20);

// // // // //     // ገና ሙሉ ላልተጫኑ እቃዎች ብቻ እናጣራለን - ግምታዊ ማጣሪያ በ status ደረጃ ካደረግን በኋላ
// // // // //     // ትክክለኛውን "ቀርቷል/አላለቀም" ውሳኔ በ ledger ደረጃ በ JS እናረጋግጣለን።
...
// // // // //       .map(item => ({ item, remaining: computeRemaining(item) }))
// // // // //       .filter(({ remaining }) => remaining.remainingWeight > 0)
// // // // //       .map(({ item, remaining }) => ({
// // // // //         id: item.id,
...
// // // // //     const paged = pendingRows.slice((page - 1) * pageSize, page * pageSize);
...
// // // // //     return res.status(500).json({ success: false, error: 'የመጋዘን እቃዎችን ማምጣት አልተቻለም' });
// // // // //   }
// // // // // });
...
// // // // // // GET /api/loading/trucks?status=ARCHIVED&search=...&page=1&pageSize=10
...
// // // // //     return res.status(500).json({ success: false, error: 'መኪኖችን ማምጣት አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // POST /api/loading/trucks — አዲስ ንቁ መኪና መዝገብ መፍጠር (ገና ያልተቀመጠ/ባዶ ወይም የተሞላ)
...
// // // // //     // 💰 የአሁኑን ነባሪ ተመን ከ LaborRateSetting እንወስዳለን (የለም ከሆነ 0.30/0.35 ነባሪ)
...
// // // // //     return res.status(500).json({ success: false, error: 'መኪና መመዝገብ አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // PATCH /api/loading/trucks/:id — ፎርም ማስተካከያ (ስም/ስልክ/ወዘተ) + "💾 መዝግብ" ተጭኖ isSaved:true ማድረግ
...
// // // // //         return res.status(400).json({ success: false, error: '❌ እባክዎ የመኪና ታርጋ ቁጥር ያስገቡ!' });
// // // // //       }
// // // // //       if (!truckType) {
// // // // //         return res.status(400).json({ success: false, error: '❌ እባክዎ የመኪና አይነት ይምረጡ!' });
// // // // //       }
// // // // //     }
...
// // // // //     return res.status(500).json({ success: false, error: 'መኪና ማዘመን አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // DELETE /api/loading/trucks/:id — ንቁ (ገና ያልተጫነ) መኪና ከዝርዝሩ ማስወገጃ
// // // // // router.delete('/trucks/:id', async (req: Request, res: Response) => {
// // // // //   try {
// // // // //     const { id } = req.params;
// // // // //     const activeCount = await prisma.truck.count({ where: { status: 'ACTIVE' } });
// // // // //     if (activeCount <= 1) {
// // // // //       return res.status(400).json({ success: false, error: '⚠️ ቢያንስ አንድ ንቁ ጭነት መኪና መኖር አለበት!' });
// // // // //     }
// // // // //     await prisma.truck.delete({ where: { id } });
// // // // //     return res.json({ success: true });
// // // // //   } catch (error: any) {
// // // // //     console.error('❌ መኪና ማስወገድ አልተቻለም:', error);
// // // // //     return res.status(500).json({ success: false, error: 'መኪና ማስወገድ አልተቻለም' });
// // // // //   }
// // // // // });
...
// // // // // // body: { cargoItemId, packageId?, weight, source, method? }
// // // // // router.post('/trucks/:truckId/load', async (req: Request, res: Response) => {
// // // // //   try {
// // // // //     const { truckId } = req.params;
// // // // //     const { cargoItemId, packageId, weight, source, method } = req.body;

// // // // //     const truck = await prisma.truck.findUnique({ where: { id: truckId } });
// // // // //     if (!truck || !truck.isSaved) {
// // // // //       return res.status(400).json({ success: false, error: "⚠️ እባክዎ መጀመሪያ የመኪናውን መረጃ ሞልተው መዝግቡ (Save)!" });
// // // // //     }
// // // // //     if (!source) {
// // // // //       return res.status(400).json({ success: false, error: "⚠️ እባክዎ 'ማን እንደጫነው' ይምረጡ!" });
// // // // //     }
// // // // //     if (source === 'የመጋዘን ጫኝ አውራጅ' && !method) {
// // // // //       return res.status(400).json({ success: false, error: "⚠️ ከመጋዘን ጫኞች ስር 'የአጫጫን ስልት' ይምረጡ!" });
// // // // //     }

// // // // //     const cargoItem = await prisma.cargoItem.findUnique({ where: { id: cargoItemId }, include: { loadings: true } });
// // // // //     if (!cargoItem) {
// // // // //       return res.status(404).json({ success: false, error: 'እቃው አልተገኘም' });
// // // // //     }

// // // // //     const remaining = computeRemaining(cargoItem);
// // // // //     const weightNum = Number(weight);
// // // // //     if (weightNum <= 0 || weightNum > remaining.remainingWeight + 0.001) {
// // // // //       return res.status(400).json({ success: false, error: `⚠️ የገባው ክብደት ትክክል አይደለም (ቀሪ፦ ${remaining.remainingWeight} ኪ.ግ)` });
// // // // //     }

// // // // //     const loading = await prisma.loading.create({
// // // // //       data: {
// // // // //         cargoItemId,
...
// // // // //     // ሙሉ ለሙሉ ከተጫነ status ማዘመን (ለፍለጋ/ሪፖርት ምቾት ብቻ - ትክክለኛው ስሌት ledger ውስጥ ነው)
...
// // // // //     return res.status(201).json({ success: true, data: loading });
// // // // //   } catch (error: any) {
// // // // //     console.error('❌ እቃ መጫን አልተቻለም:', error);
// // // // //     return res.status(500).json({ success: false, error: 'እቃ መጫን አልተቻለም' });
// // // // //   }
// // // // // });
...
// // // // //     const refreshed = await prisma.cargoItem.findUnique({ where: { id: loading.cargoItemId }, include: { loadings: true } });
// // // // //     if (refreshed) {
// // // // //       const remaining = computeRemaining(refreshed);
// // // // //       await prisma.cargoItem.update({
// // // // //         where: { id: refreshed.id },
// // // // //         data: { status: remaining.remainingWeight >= refreshed.weight ? 'በመጋዘን ያለ' : (remaining.isFullyLoaded ? 'ተጭኗል' : 'ከፊል ተጭኗል') }
// // // // //       });
// // // // //     }

// // // // //     return res.json({ success: true, data: loading });
// // // // //   } catch (error: any) {
// // // // //     console.error('❌ ማውረድ አልተቻለም:', error);
// // // // //     return res.status(500).json({ success: false, error: 'ማውረድ አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // POST /api/loading/cargo-items/:cargoItemId/shortage
// // // // // // body: { truckId, weight, quantityText, reason }
...
// // // // //     if (!reason) {
// // // // //       return res.status(400).json({ success: false, error: '⚠️ የቅናሽ ምክንያት ያስፈልጋል!' });
// // // // //     }
...
// // // // //     return res.status(500).json({ success: false, error: 'ቅናሽ ሪፖርት መመዝገብ አልተቻለም' });
// // // // //   }
// // // // // });
...
// // // // //     const truck = await prisma.truck.findUnique({ where: { id: truckId } });
// // // // //     if (!truck) return res.status(404).json({ success: false, error: 'መኪናው አልተገኘም' });
...
// // // // //     // በደረሰኝ (receipt) መሰብሰብ - ልክ እንደ ፍሮንት ኤንዱ loadedGroupsMap
// // // // //     const grouped: Record<string, { merchantName: string; merchantPhone: string; receiptNo: string; itemsText: string[]; dryWeight: number; letefWeight: number }> = {};

// // // // //     for (const l of loadings) {
// // // // //       const key = `${l.cargoItem.receipt.merchantName}-${l.cargoItem.receipt.receiptNo}`;
// // // // //       if (!grouped[key]) {
// // // // //         grouped[key] = {
...
// // // // //         };
// // // // //       }
// // // // //       grouped[key].itemsText.push(`${l.cargoItem.description} — ${l.weight} ኪ.ግ`);
// // // // //       if (l.cargoItem.category === 'ደረቅ') grouped[key].dryWeight += l.weight;
// // // // //       else grouped[key].letefWeight += l.weight;
// // // // //     }
...
// // // // //     // የክፍያ ስሌት (ለ 'ከመጋዘን'/'ከመኪና' ስልት ብቻ ክፍያ ይሰላል)
// // // // //     const gateWeight = loadings.filter(l => l.source === 'የመጋዘን ጫኝ አውራጅ' && l.method === 'ከመጋዘን').reduce((s, l) => s + l.weight, 0);
// // // // //     const truckWeight = loadings.filter(l => l.source === 'የመጋዘን ጫኝ አውራጅ' && l.method === 'ከመኪና').reduce((s, l) => s + l.weight, 0);
// // // // //     const transitWeight = loadings.filter(l => l.source === 'መኪናው ጭኖት የመጣ').reduce((s, l) => s + l.weight, 0);
// // // // //     const externalWeight = loadings.filter(l => l.source === 'ከውጭ ጫኞች').reduce((s, l) => s + l.weight, 0);
...
// // // // //         labor: { gateWeight, truckWeight, transitWeight, externalWeight, gateCost, truckCost, totalPayout: Number((gateCost + truckCost).toFixed(2)) }
// // // // //       }
// // // // //     });
// // // // //   } catch (error: any) {
// // // // //     console.error('❌ የመኪና ማጠቃለያ ማምጣት አልተቻለም:', error);
// // // // //     return res.status(500).json({ success: false, error: 'የመኪና ማጠቃለያ ማምጣት አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // POST /api/loading/trucks/:truckId/confirm — ጭነት ተጠናቅቆ ወደ ማህደር ማዛወሪያ
// // // // // router.post('/trucks/:truckId/confirm', async (req: Request, res: Response) => {
// // // // //   try {
// // // // //     const { truckId } = req.params;

// // // // //     // 🎯 ከ ledger አካሄድ የተነሳ ምንም "ማንቀሳቀስ/መቅዳት" አያስፈልግም - Loading ዎቹ እዚያው
// // // // //     // ይቀራሉ (ታሪካዊ መዝገብ)፣ Truck.status ብቻ ነው ARCHIVED ወደሚል የሚቀየረው።
// // // // //     const truck = await prisma.truck.update({
// // // // //       where: { id: truckId },
// // // // //       data: { status: 'ARCHIVED', completionDate: new Date() }
// // // // //     });

// // // // //     return res.json({ success: true, data: truck, message: `🎉 የጭነት መኪና (${truck.plateNumber}) ጭነት ተቆልፎ ወደ ማህደር ተዛውሯል!` });
// // // // //   } catch (error: any) {
// // // // //     console.error('❌ ጭነት መቆለፍ አልተቻለም:', error);
// // // // //     return res.status(500).json({ success: false, error: 'ጭነት መቆለፍ አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // =====================================================================
// // // // // // 🗄️ 5. ማህደር-ተኮር ተግባራት (ተመን ማስተካከያ / ልዩ እቃ / ማረጋገጫ)
// // // // // // =====================================================================

// // // // // // PATCH /api/loading/trucks/:truckId/rates — body: { gateRate?, truckRate? }
...
// // // // //     if (!existing) return res.status(404).json({ success: false, error: 'መኪናው አልተገኘም' });
// // // // //     if (existing.isVerified) {
// // // // //       return res.status(400).json({ success: false, error: '⚠️ ክፍያው ተረጋግጦ ስለተቆለፈ ተመኑን መቀየር አይቻልም!' });
// // // // //     }
...
// // // // //     return res.status(500).json({ success: false, error: 'ተመን ማዘመን አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // POST /api/loading/trucks/:truckId/non-kg-items — body: { name, qty, rate }
...
// // // // //     if (!name || !qty || !rate) {
// // // // //       return res.status(400).json({ success: false, error: '⚠️ እባክዎ ሁሉንም መስኮች ይሙሉ!' });
// // // // //     }
...
// // // // //     return res.status(500).json({ success: false, error: 'ልዩ እቃ መመዝገብ አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // PATCH /api/loading/trucks/:truckId/verify — የክፍያ የመጨረሻ ማረጋገጫ መቆለፊያ
...
// // // // //     return res.json({ success: true, data: truck, message: '✔ የጫኞች ክፍያ በተሳካ ሁኔታ ተቆልፎ ተመዝግቧል!' });
// // // // //   } catch (error: any) {
// // // // //     console.error('❌ ማረጋገጥ አልተቻለም:', error);
// // // // //     return res.status(500).json({ success: false, error: 'ማረጋገጥ አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // =====================================================================
// // // // // // 💰 6. የክፍያ ተመን ቅንብር (ቢሮ/አስጫኙ በማንኛውም ጊዜ የሚቀይሩት)
// // // // // // =====================================================================

// // // // // // GET /api/loading/rate-settings — የአሁኑን ነባሪ ተመን ማምጫ
...
// // // // //     return res.json({ success: true, data: latest || { gateRate: 0.30, truckRate: 0.35 } });
// // // // //   } catch (error: any) {
// // // // //     console.error('❌ ተመን ማምጣት አልተቻለም:', error);
// // // // //     return res.status(500).json({ success: false, error: 'ተመን ማምጣት አልተቻለም' });
// // // // //   }
// // // // // });

// // // // // // POST /api/loading/rate-settings — አዲስ ነባሪ ተመን መመዝገቢያ (ታሪኩ እየተቀመጠ)
...
// // // // //     return res.status(500).json({ success: false, error: 'ተመን መመዝገብ አልተቻለም' });
// // // // //   }
// // // // // });
...
// // // //   if (!cargoItem.isMultiPackage || !cargoItem.packages) return [];
// // // //   try {
// // // //     return Array.isArray(cargoItem.packages) ? (cargoItem.packages as any[]) : [];
// // // //   } catch {
// // // //     return [];
// // // //   }
// // // // }
...
// // // //     const loadedPkgIds = new Set(activeLoadings.map((l: any) => l.packageId).filter(Boolean));
// // // //     const remainingPkgs = pkgs.filter(p => !loadedPkgIds.has(p.id));
// // // //     const remainingWeight = remainingPkgs.reduce((s: number, p: any) => s + (Number(p.weight) || 0), 0);
// // // //     return { remainingWeight, remainingPkgCount: remainingPkgs.length, remainingPkgs, isFullyLoaded: remainingPkgs.length === 0 };
// // // //   }

// // // //   const loadedWeight = activeLoadings.reduce((s: number, l: any) => s + (Number(l.weight) || 0), 0);
// // // //   const remainingWeight = Math.max(0, (Number(cargoItem.weight) || 0) - loadedWeight);
// // // //   return { remainingWeight, remainingPkgCount: 0, remainingPkgs: [], isFullyLoaded: remainingWeight <= 0 };
// // // // }
...
// // // //   });
// // // //   return loadings
// // // //     .filter(l => !filters?.category || (l.cargoItem as any)?.category === filters.category)
// // // //     .reduce((s, l) => s + l.weight, 0);
// // // // }
...
// // // //         id: item.id,
// // // //         receiptId: item.receiptId,
// // // //         receiptNo: (item as any).receipt?.receiptNo,
// // // //         dateIn: (item as any).receipt?.ethDate,
// // // //         merchantName: (item as any).receipt?.merchantName,
// // // //         merchantPhone: (item as any).receipt?.merchantPhone,
// // // //         description: item.description,
// // // //         category: item.category,
// // // //         isMultiPackage: item.isMultiPackage,
// // // //         weight: remaining.remainingWeight,
...
// // // //     for (const l of loadings) {
// // // //       const cargoItem = l.cargoItem as any;
// // // //       const key = `${cargoItem.receipt.merchantName}-${cargoItem.receipt.receiptNo}`;
// // // //       if (!grouped[key]) {
// // // //         grouped[key] = {
// // // //           merchantName: cargoItem.receipt.merchantName,
// // // //           merchantPhone: cargoItem.receipt.merchantPhone || '-',
// // // //           receiptNo: cargoItem.receipt.receiptNo,
// // // //           itemsText: [],
// // // //           dryWeight: 0,
// // // //           letefWeight: 0
// // // //         };
// // // //       }
// // // //       grouped[key].itemsText.push(`${cargoItem.description} — ${l.weight} ኪ.ግ`);
// // // //       if (cargoItem.category === 'ደረቅ') grouped[key].dryWeight += l.weight;
// // // //       else grouped[key].letefWeight += l.weight;
// // // //     }
...
// // // async function getTruckLoadedWeight(truckId: string, filters?: { category?: string; source?: string; method?: string }) {
// // //   const loadings = await prisma.loading.findMany({
// // //     where: { truckId: truckId as any, isActive: true, ...(filters?.source ? { source: filters.source } : {}), ...(filters?.method ? { method: filters.method } : {}) },
// // //     include: { cargoItem: true }
// // //   });
// // //   return loadings
// // //     .filter(l => !filters?.category || (l.cargoItem as any)?.category === filters.category)
...
// // //       return res.status(400).json({ success: false, error: '⚠️ ቢያንስ አንድ ንቁ ጭነት መኪና መኖር አለበት!' });
// // //     }
// // //     await prisma.truck.delete({ where: { id: id as any } });
// // //     return res.json({ success: true });
// // //   } catch (error: any) {
// // //     console.error('❌ መኪና ማስወገድ አልተቻለም:', error);
// // //     return res.status(500).json({ success: false, error: 'መኪና ማስወገድ አልተቻለም' });
...
// // //     const truck = await prisma.truck.findUnique({ where: { id: truckId as any } });
// // //     if (!truck || !truck.isSaved) {
// // //       return res.status(400).json({ success: false, error: "⚠️ እባክዎ መጀመሪያ የመኪናውን መረጃ ሞልተው መዝግቡ (Save)!" });
// // //     }
// // //     if (!source) {
...
// // //     const cargoItem = await prisma.cargoItem.findUnique({ where: { id: cargoItemId as any }, include: { loadings: true } });
// // //     if (!cargoItem) {
// // //       return res.status(404).json({ success: false, error: 'እቃው አልተገኘም' });
// // //     }
...
// // //     const loading = await prisma.loading.create({
// // //       data: {
// // //         cargoItemId: cargoItemId as any,
// // //         packageId: packageId || null,
...
// // //     // ሙሉ ለሙሉ ከተጫነ status ማዘመን (ለፍለጋ/ሪፖርት ምቾት ብቻ - ትክክለኛው ስሌት ledger ውስጥ ነው)
// // //     const refreshed = await prisma.cargoItem.findUnique({ where: { id: cargoItemId as any }, include: { loadings: true } });
// // //     const newRemaining = computeRemaining(refreshed);
// // //     await prisma.cargoItem.update({
// // //       where: { id: cargoItemId as any },
// // //       data: { status: newRemaining.isFullyLoaded ? 'ተጭኗል' : 'ከፊል ተጭኗል' }
// // //     });
...
// // //     const loading = await prisma.loading.update({
// // //       where: { id: loadingId as any },
// // //       data: { isActive: false, unloadedAt: new Date() }
// // //     });

// // //     const refreshed = await prisma.cargoItem.findUnique({ where: { id: loading.cargoItemId as any }, include: { loadings: true } });
// // //     if (refreshed) {
// // //       const remaining = computeRemaining(refreshed);
// // //       await prisma.cargoItem.update({
// // //         where: { id: refreshed.id as any },
// // //         data: { status: remaining.remainingWeight >= refreshed.weight ? 'በመጋዘን ያለ' : (remaining.isFullyLoaded ? 'ተጭኗል' : 'ከፊል ተጭኗል') }
// // //       });
// // //     }
...
// // //     const loadings = await prisma.loading.findMany({
// // //       where: { truckId: truckId as any, isActive: true },
// // //       include: { cargoItem: { include: { receipt: true } } }
// // //     });
...
// // //     const existing = await prisma.truck.findUnique({ where: { id: truckId as any } });
// // //     if (!existing) return res.status(404).json({ success: false, error: 'መኪናው አልተገኘም' });
// // //     if (existing.isVerified) {
// // //       return res.status(400).json({ success: false, error: '⚠️ ክፍያው ተረጋግጦ ስለተቆለፈ ተመኑን መቀየር አይቻልም!' });
// // //     }
...
// // //     const cost = Number(qty) * Number(rate);
// // //     const item = await prisma.nonKgLaborItem.create({
// // //       data: { truckId: truckId as any, name, qty: Number(qty), rate: Number(rate), cost }
// // //     });
...
// // //   try {
// // //     const { truckId } = req.params;
// // //     const truck = await prisma.truck.update({ where: { id: truckId as any }, data: { isVerified: true } });
// // //     return res.json({ success: true, data: truck, message: '✔ የጫኞች ክፍያ በተሳካ ሁኔታ ተቆልፎ ተመዝግቧል!' });
// // //   } catch (error: any) {
// // //     console.error('❌ ማረጋገጥ አልተቻለም:', error);
// // //     return res.status(500).json({ success: false, error: 'ማረጋገጥ አልተቻለም' });
...
// //       // 🎯 ጉድለት #2 ፍታ፦ ለያንዳንዱ ንቁ መኪና ጠቅላላ የተጫነ ክብደት እዚሁ እናያይዛለን
// //       // (አቺቭመንት ገጽ ላይ ላለው "የመኪናዎች ሰሌዳ" board card ራሱን ችሎ summary መጥራት ሳያስፈልገው)
// //       const trucksWithWeight = await Promise.all(
// //         trucks.map(async (truck) => {
// //           const agg = await prisma.loading.aggregate({
// //             where: { truckId: truck.id, isActive: true },
// //             _sum: { weight: true }
// //           });
...
// //       return res.json({ success: true, data: trucksWithWeight });
// //     }
...
// // // GET /api/loading/trucks/:id — 🎯 ጉድለት #4 ፍታ (single truck fetch)
...
// //     return res.json({ success: true, data: { ...truck, loadedWeight: agg._sum.weight || 0 } });
// //   } catch (error: any) {
// //     console.error('❌ መኪና ማምጣት አልተቻለም:', error);
// //     return res.status(500).json({ success: false, error: 'መኪና ማምጣት አልተቻለም' });
// //   }
// // });
...
// //     if (loadedCount > 0) {
// //       return res.status(400).json({ success: false, error: '⚠️ ይህ መኪና ላይ የተጫኑ እቃዎች ስላሉ መሰረዝ አይቻልም - መጀመሪያ እቃዎቹን ያውርዱ!' });
// //     }
// //     await prisma.truck.delete({ where: { id } });
// //     return res.json({ success: true });
// //   } catch (error: any) {
...
// //     // shortage (optional) = { weight, quantityText, reason } — ያልተጫነውን ክፍል በተመሳሳይ ጥሪ ለመመዝገብ
...
// //       return res.status(400).json({ success: false, error: '⚠️ የቅናሽ ክብደት ያስፈልጋል!' });
// //     }

// //     // 🎯 መጫንን እና (ካለ) ቅናሽ ሪፖርትን በአንድ transaction ውስጥ አንድ ላይ እንመዘግባለን
...
// // // POST /api/loading/trucks/:truckId/load-batch — 🎯 ጉድለት #1 ፍታ
// // // ፍሮንት ኤንዱ ብዙ ኬሻዎችን (multi-package checkboxes) በአንድ ጊዜ ሲጭን ይህ ጥቅም ላይ ይውላል።
// // // body: { source, method, items: [{ cargoItemId, packageId?, weight }, ...] }
...
// //       return res.status(400).json({ success: false, error: '⚠️ የሚጫን እቃ አልተመረጠም!' });
// //     }
...
// //     // ሁሉም እቃዎች ትክክለኛ ቀሪ ክብደት እንዳላቸው አስቀድሞ ማረጋገጥ (ከፊሉ ካልተሳካ ምንም እንዳይመዘገብ)
// //     const cargoItemIds = [...new Set(items.map((i: any) => i.cargoItemId))];
// //     const cargoItems = await prisma.cargoItem.findMany({ where: { id: { in: cargoItemIds } }, include: { loadings: true } });
// //     const cargoMap = new Map(cargoItems.map(c => [c.id, c]));

// //     for (const it of items) {
// //       const cargo = cargoMap.get(it.cargoItemId);
// //       if (!cargo) return res.status(404).json({ success: false, error: 'አንድ ወይም ከዚያ በላይ እቃዎች አልተገኙም' });
// //       const remaining = computeRemaining(cargo);
// //       if (Number(it.weight) <= 0 || Number(it.weight) > remaining.remainingWeight + 0.001) {
// //         return res.status(400).json({ success: false, error: `⚠️ የ${cargo.description} ክብደት ትክክል አይደለም (ቀሪ፦ ${remaining.remainingWeight} ኪ.ግ)` });
// //       }
// //     }
...
// //     // ሁሉንም የተነኩ CargoItem ዎችን status ማዘመን
// //     for (const cargoItemId of cargoItemIds) {
// //       const refreshed = await prisma.cargoItem.findUnique({ where: { id: cargoItemId as string }, include: { loadings: true } });
// //       if (refreshed) {
// //         const newRemaining = computeRemaining(refreshed);
// //         await prisma.cargoItem.update({
// //           where: { id: cargoItemId as string },
// //           data: { status: newRemaining.isFullyLoaded ? 'ተጭኗል' : 'ከፊል ተጭኗል' }
// //         });
// //       }
// //     }

// //     return res.status(201).json({ success: true, data: loadings, message: `✔️ ${loadings.length} እቃዎች ታርጋ ${truck.plateNumber} ላይ ተጭነዋል!` });
// //   } catch (error: any) {
// //     console.error('❌ በጅምላ መጫን አልተቻለም:', error);
// //     return res.status(500).json({ success: false, error: 'በጅምላ መጫን አልተቻለም' });
// //   }
// // });
...
// // // POST /api/loading/cargo-items/:cargoItemId/shortage
// // // body: { truckId, weight, quantityText, reason }
// // // PATCH /api/loading/cargo-items/:id — ምድብ (ደረቅ/ለጠፍ) ማስተካከያ (Section 3 ላይ ላለው dropdown)
// // router.patch('/cargo-items/:id', async (req: Request, res: Response) => {
// //   try {
// //     const { id } = req.params;
// //     const { category } = req.body;
// //     if (!category) return res.status(400).json({ success: false, error: 'ምድብ ያስፈልጋል' });

// //     const item = await prisma.cargoItem.update({ where: { id }, data: { category } });
// //     return res.json({ success: true, data: item });
// //   } catch (error: any) {
// //     console.error('❌ ምድብ ማዘመን አልተቻለም:', error);
// //     return res.status(500).json({ success: false, error: 'ምድብ ማዘመን አልተቻለም' });
// //   }
// // });
...
// //     // በደረሰኝ (receipt) መሰብሰብ - ልክ እንደ ፍሮንት ኤንዱ loadedGroupsMap
// //     const grouped: Record<string, { merchantName: string; merchantPhone: string; receiptNo: string; itemsText: string[]; dryWeight: number; letefWeight: number; loadingIds: string[] }> = {};
...
// //       }
// //       grouped[key].itemsText.push(`${l.cargoItem.description} — ${l.weight} ኪ.ግ`);
// //       grouped[key].loadingIds.push(l.id);
// //       if (l.cargoItem.category === 'ደረቅ') grouped[key].dryWeight += l.weight;
// //       else grouped[key].letefWeight += l.weight;
// //     }
...
// //     // 🎯 ጉድለት #3 ፍታ፦ ለ"አውርድ/መልስ" UI የሚያስፈልገው እያንዳንዱ Loading ራሱ (እውነተኛ id ኖሮት)
// //     // ፍሮንት ኤንዱ ማውረድ ሲፈልግ ይህንኑ loading.id ወደ POST /loadings/:id/unload ይልካል።
// //     const loadingsDetail = loadings.map(l => ({
// //       id: l.id,
...
// // PATCH /api/loading/cargo-items/:id — ምድብ ማስተካከያ
// router.patch('/cargo-items/:id', async (req: Request, res: Response) => {
//   try {
//     const { id } = req.params;
//     const { category } = req.body;
...
// // POST /api/loading/rate-settings — አዲስ ነባሪ ተመን መመዝገቢያ
// router.post('/rate-settings', async (req: Request, res: Response) => {
//   try {
//     const { gateRate, truckRate, changedBy } = req.body;
//     const setting = await prisma.laborRateSetting.create({
...
// const uploadDir = path.join(process.cwd(), 'uploads', 'truck-accounting');
...
router.get('/warehouse-items', async (req: Request, res: Response) => {
  ...
  .map(({ item, remaining }: any) => {
    ...
    //   // ✅ ትክክለኛ ቀሪ የኬሻ ቁጥር ስላለን በቀጥታ እንጠቀማለን
    ...
    //   // 📐 ነጠላ እቃ ላይ በክብደት መጠን ተመጣጣኝ የቀረውን ብዛት እናሰላለን
    //   const qtyMatch = item.description.match(/^(\d+)/);
    //   if (qtyMatch) {
    //     const originalQty = Number(qtyMatch[1]);
...
//   displayDescription = updateDescriptionQuantity(item.description, remaining.remainingPkgCount);
// } else if (remaining.remainingWeight < item.weight) {
//   // ✅ በቅድሚያ ካንተ በእጅ የገባውን ትክክለኛ የቅናሽ ቁጥር (shortageItemQty) እንጠቀማለን — ግምት አያስፈልግም
//   const originalQty = parseLeadingQty(item.description);
//   const shortageQty = parseLeadingQty(item.shortageNotes?.[0]?.quantityText);

//   if (originalQty !== null && shortageQty !== null) {
//     displayDescription = updateDescriptionQuantity(item.description, shortageQty);
//   } else if (originalQty !== null) {
//     // 🔁 fallback: quantityText ካልገባ (ባዶ ከቀረ) ብቻ በክብደት እንገምታለን
//     const remainingQty = Math.max(0, Math.round(originalQty * remaining.remainingWeight / item.weight));
//     displayDescription = updateDescriptionQuantity(item.description, remainingQty);
//   }
// }
...
//   g.itemsText = Object.entries(mergedByName).map(([itemName, m]) => {
//   let line = `${m.qty} ${itemName}`; // ✅ ኪ.ግ በቅንፍ አይታይም — ጠቅላላ ደረቅ/ለጠፍ ኪ.ግ ራሱ ሰንጠረዡ ላይ ስላለ
//   if (m.reasons.size > 0) {
//     line += ` — ⚠️ ${Array.from(m.reasons).join('፣ ')}`;
//   }
//   return line;
...
headerRow.height = 32;
    ...
    // 📋 የነጋዴዎች ዝርዝር - ካንተ ጠየቅከው መሰረት ተ.ቁ (A) ባዶ ነው (በእጅ ትሞላዋለህ)
